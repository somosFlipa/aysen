	...
	$(document).ready(function() {
		...
		$('.search-close-btn').on('click', function(e) {
			...
			if ($('.tours').hasClass('tours-list')) {
					$('.tour-list-icon').css('color', '#92be3e');
			}

			if ($('.tours').hasClass('tours-grid')) {
					$('.tour-grid-icon').css('color', '#92be3e');
			}
		...
		if ($('.posts').hasClass('blog-posts-list')) {
				$('.blog-list-icon').css('color', '#92be3e');
		}

		if ($('.posts').hasClass('blog-posts-grid')) {
				$('.blog-grid-icon').css('color', '#92be3e');
		}
		...
		// SLIDER
		var menu = ['COMUNA DE AYSEN<span>MAÑIHUALES</span>', 'COMUNA DE AYSEN<span>PUERTO AYSEN</span>', 'COMUNA DE AYSEN<span>PUERTO CHACABUCO</span>', 'COMUNA DE AYSEN<span>ISLAS HUICHAS</span>'];
